...
import { Moon, PanelLeft, RefreshCw, Search, Settings, Sun } from 'lucide-react';

export default function Toolbar({ view, sidebarHidden, onToggleSidebar, onOpenPalette, onReload, appearance, onOpenPreferences }) {
