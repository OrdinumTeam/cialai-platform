...
// Package pairingv1 keeps the Headscale-era CIALAI1 QR payloads, pre-auth
// pairing sessions and the devices.json v1 registry used by the Headscale
// edge, sidecar and mobile tunnel until that mode is removed in phase 6
// (decision CON-D12). New code uses the parent pairing package.
package pairingv1
