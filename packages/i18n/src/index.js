...
export const dictionaries = Object.freeze({
  'pt-BR': Object.freeze({
    ...
    'connection.connecting': 'Conectando ao computador…',
    'connection.disabled': 'Ponte com o computador desconectada',
    'connection.disconnected': 'Ponte com o computador desconectada',
    'connection.incompatible': 'Atualize o Cialai para continuar',
    'connection.removed': 'Este aparelho foi removido',
  ...
  en: Object.freeze({
    ...
    'connection.connecting': 'Connecting to computer…',
    'connection.disabled': 'Computer connection is offline',
    'connection.disconnected': 'Computer connection is offline',
    'connection.incompatible': 'Update Cialai to continue',
    'connection.removed': 'This device was removed',
