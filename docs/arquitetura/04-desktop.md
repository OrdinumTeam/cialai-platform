...
| Comando de terminal | `~/.local/bin/cialai` | Igual | `%LOCALAPPDATA%\Programs\Cialai\bin\cialai.cmd`, com a pasta no `Path` do usuário |
| Lápide do comando de terminal | `<app_config_dir>/cli-disabled` | Igual | Igual |
